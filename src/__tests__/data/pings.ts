...
export const PINGS_STUDY_INFO: StudyInfo = StudyInfoSchema.parse({
  ...
  streamsOrder: {
    sunday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
    monday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
    tuesday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
    wednesday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
    thursday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
    friday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
    saturday: ["cat", "dog", "wolf", "lynx", "cat", "dog"],
  },
